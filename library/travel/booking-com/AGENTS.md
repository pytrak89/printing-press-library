# Booking.com Printed CLI Agent Guide

This directory is a generated `booking-com-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
booking-com-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
booking-com-pp-cli which "<capability>" --json
booking-com-pp-cli <command> --help
```
...
```bash
booking-com-pp-cli <command> --agent
```
...
```bash
booking-com-pp-cli <command> --help
booking-com-pp-cli <command> --dry-run --agent
```
