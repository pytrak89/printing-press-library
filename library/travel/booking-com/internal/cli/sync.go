...
Resource scoping:
  ...
  booking-com-pp-cli sync

  # Sync specific resources only
  booking-com-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  booking-com-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  booking-com-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  booking-com-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  booking-com-pp-cli sync --latest-only`,
