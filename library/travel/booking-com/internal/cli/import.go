...
but do not stop the import.`,
  ...
  booking-com-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  booking-com-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | booking-com-pp-cli import <resource> --input -`,
