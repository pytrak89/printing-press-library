...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  booking-com-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  booking-com-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"cars", "trips", "wishlist"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  booking-com-pp-cli workflow status

  # Show status as JSON
  booking-com-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("booking-com-pp-cli")
			}
