...
but do not stop the import.`,
  ...
  loopnet-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  loopnet-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | loopnet-pp-cli import <resource> --input -`,
