...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "elezioni-sicilia-pp-cli",
		Short: `Dati elettorali comunali siciliani da riga di comando — affluenza, candidati, liste, risultati in JSON o tabella.`,
		Long: `Dati elettorali comunali siciliani da riga di comando — affluenza, candidati, liste, risultati in JSON o tabella.
...
Health check: run 'elezioni-sicilia-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("elezioni-sicilia-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'elezioni-sicilia-pp-cli profile list')")
	...
	// HTML scraper implementations replace generated promoted commands
	rootCmd.AddCommand(newAffluenzaCmd(flags))
	rootCmd.AddCommand(newCandidatiCmd(flags))
	rootCmd.AddCommand(newComuniCmd(flags))
	rootCmd.AddCommand(newListeCmd(flags))
	rootCmd.AddCommand(newRisultatiCmd(flags))
	rootCmd.AddCommand(newSeggiCmd(flags))
	// Transcendence commands
	rootCmd.AddCommand(newStatoCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("elezioni-sicilia-pp-cli %s\n", version)
		},
	}
}
