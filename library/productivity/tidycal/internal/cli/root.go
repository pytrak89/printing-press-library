...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "tidycal-pp-cli",
		Short: "Manage tidycal resources via the tidycal API",
		Long: `Manage tidycal resources via the tidycal API.
...
Run 'tidycal-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("tidycal-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'tidycal-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBookingTypesCmd(flags))
	...
	rootCmd.AddCommand(newBriefCmd(flags))
	rootCmd.AddCommand(newTriageCmd(flags))
	rootCmd.AddCommand(newProposeTimesCmd(flags))
	rootCmd.AddCommand(newFollowupsCmd(flags))
	rootCmd.AddCommand(newAssistedBookCmd(flags))
