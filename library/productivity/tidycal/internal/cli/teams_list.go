...
func newTeamsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Get a list of teams the authenticated user has access to.",
		Example:     "  tidycal-pp-cli teams list",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "teams", path, map[string]string{}, nil, flagAll, "page", "page", "", "", "", cmd.ErrOrStderr())
			if err != nil {
