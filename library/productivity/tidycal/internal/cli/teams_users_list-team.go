...
func newTeamsUsersListTeamCmd(flags *rootFlags) *cobra.Command {
	var flagPage string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:         "list-team <team>",
		Aliases:     []string{"get"},
		Short:       "Get a list of users in a specific team.",
		Example:     "  tidycal-pp-cli teams users list-team 42",
		Annotations: map[string]string{"pp:endpoint": "users.list-team", "pp:method": "GET", "pp:path": "/teams/{team}/users", "mcp:read-only": "true"},
